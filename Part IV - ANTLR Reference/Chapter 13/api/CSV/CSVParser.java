...
public class CSVParser extends Parser {
	...
	public final RowContext row() throws RecognitionException {
		...
		try {
			...
			{
			setState(13);
			((RowContext)_localctx).a = field();
			setState(14);
			match(T__0);
			setState(15);
			((RowContext)_localctx).b = field();
			setState(17);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__1) {
			...
			match(T__2);
			      ...
			      x += Double.valueOf((((RowContext)_localctx).a!=null?(((RowContext)_localctx).a.start):null).getText());
			      y += Double.valueOf((((RowContext)_localctx).b!=null?(((RowContext)_localctx).b.start):null).getText());
