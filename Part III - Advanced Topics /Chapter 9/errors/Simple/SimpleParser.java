	...
	public final MemberContext member() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(28);
				match(T__4);
				 System.out.println("var " + ((MemberContext)_localctx).ID.getText()); 
				}
				break;
			case 2:
				...
				setState(37);
				match(T__2);
				 System.out.println("method: " + ((MemberContext)_localctx).f.getText()); 
				}
				break;
			}
		}
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(49);
				match(T__4);
				 System.out.println("found assign: " + (((StatContext)_localctx).ID!=null?((StatContext)_localctx).ID.getText():null) + " = " + (((StatContext)_localctx).expr!=null?_input.getText(((StatContext)_localctx).expr.start,((StatContext)_localctx).expr.stop):null)); 
				}
				break;
			}
		}
